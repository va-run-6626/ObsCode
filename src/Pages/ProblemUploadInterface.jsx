            ...
            <div className="w-[40%] h-full overflow-y-auto custom-scrollbar bg-surface-container-low px-12 py-10">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-surface-container-lowest rounded-3xl overflow-hidden border border-white/5">
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={8}
                      className="w-full bg-transparent border-none p-6 text-on-background font-mono text-sm focus:ring-0 resize-none leading-relaxed no-scrollbar"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      className="w-full bg-surface-container-lowest border-none rounded-2xl py-4 px-6 text-zinc-300 font-mono text-xs focus:ring-2 ring-white/20 transition-all no-scrollbar"
                ...
                <div className="flex gap-4">
                  <button
                    type="button"
                    className="flex-1 py-5 rounded-3xl bg-surface-container-highest text-white font-bold text-lg shadow-2xl hover:scale-[1.02] active:scale-95 transition-all"
                  >
                    Save Draft
                  </button>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex-[2] py-5 rounded-3xl bg-white text-black font-black text-lg shadow-2xl hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50"
                  >
                    {submitting ? "Publishing..." : "Produce"}
                  </button>
                </div>
                {message && (
                  <div
            ...
            <div className="w-[60%] h-full bg-background relative border-l border-white/5 p-8 flex flex-col gap-6">
              ...
              <div className="flex-1 rounded-3xl overflow-hidden border border-white/10 shadow-2xl flex flex-col opacity-80 select-none pointer-events-none">
                ...
                <div className="flex-1 flex overflow-hidden">
                  ...
                  <div className="w-[45%] h-full p-8 space-y-6 overflow-y-auto bg-surface-container-low border-r border-white/5 no-scrollbar">
