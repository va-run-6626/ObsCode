      ...
      <main className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="glass-card rounded-xl p-8 md:p-10 shadow-2xl flex flex-col gap-8">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="font-mono font-bold text-2xl tracking-tighter text-primary">
              ObsCode
            </div>
          ...
          <div className="flex flex-col gap-3 mb-2">
            <button className="w-full flex items-center justify-center gap-3 bg-surface-container-high hover:bg-surface-container-highest text-primary font-medium py-3 rounded-full transition-all duration-300 active:scale-[0.98]">
          ...
          <div className="relative flex items-center">
            ...
            <span className="flex-shrink mx-4 font-mono text-[10px] text-tertiary-fixed-dim tracking-[0.2em]">OR</span>
            <div className="flex-grow border-t border-outline-variant opacity-20"></div>
          </div>
          ...
          <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
            <div className="flex flex-col gap-1.5">
              <label className="font-mono text-[11px] uppercase tracking-wider text-secondary pl-1" htmlFor="email">Email_Address</label>
              <input
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between items-end pl-1 pr-1">
                <label className="font-mono text-[11px] uppercase tracking-wider text-secondary" htmlFor="password">Cipher_Key</label>
                <a className="font-mono text-[10px] uppercase text-accent-purple hover:text-white transition-colors" href="#">Forgot?</a>
              </div>
              <input
                className="w-full bg-surface-container-low border-none rounded-xl px-4 py-3 text-sm text-primary placeholder:text-tertiary-fixed-dim focus:ring-2 focus:ring-accent-purple/40 focus:bg-surface-container transition-all outline-none"
                id="password"
            ...
            {/* Primary Action */}
            <button className="w-full mt-2 bg-accent-purple hover:brightness-110 text-on-primary font-bold py-4 rounded-full shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-all active:scale-[0.97]" type="submit">
              Initialize Session
            </button>
          </form>
          ...
          <div className="text-center pt-2">
            <p className="text-xs text-secondary-fixed-dim">
              ...
              <Link className="text-primary font-semibold hover:underline underline-offset-4 ml-1" to="/signup">Sign Up</Link>
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 flex justify-between items-center px-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[9px] text-tertiary-fixed-dim uppercase tracking-tighter">System Nodes Online</span>
          </div>
